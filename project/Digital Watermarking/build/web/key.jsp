...
<html>
    ...
    <body>
    <center>
       <form style="position:absolute;top=80;left:300;" action="home.htm">
           <table align="center" border="1" >
               <tr>
                    <td><p><b>Your Key</b></p></td>
                    <td><input type="text" value="<%=key%>" disabled/></center><br><br></td>
</tr>
 </table>
            <br>
            <b><center><input type=submit value="SUBMIT"/></center></b>
